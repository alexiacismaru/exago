package com.company.view.Rules;
...
public class RuleScreenPresenter {
    private final RuleScreenView view;
    private final gameSession modelName;


    public RuleScreenPresenter(RuleScreenView view, gameSession modelName) {
        this.view = view;
